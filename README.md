Uma aplicação web de agenda e diário pessoal focada em minimalismo, 
performance e sincronização em tempo real. 
Criada com design inspirado no Apple Notes e Google Keep, com suporte a modo offline, galeria de imagens e integração na nuvem.
